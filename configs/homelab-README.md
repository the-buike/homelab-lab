...
![Physical Build](images/physical-build.jpg)

*Wall-mounted build with printed asset labels on every device. Top left: MikroTik hEX (RTR-HEX01). Top right: HP EliteDesk running Proxmox (PVE01). Center: TP-Link managed switch (SW-TPL01). Below: Frontier MoCA adapter and 2-bay storage enclosure.*
